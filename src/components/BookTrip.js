    ...
    return (
      <main className="h-screen">
        <h1 className="text-2xl font-black mt-40">
          Cart is empty, go and book a trip!
        </h1>
      </main>
    );
  }
  return (
    <div className="h-screen">
      <div className="flex flex-row flex-wrap justify-center pt-14">
        ...
        >
          <button
            className="bg-pink-500 rounded-full h-10 w-10 text-white font-bold"
            onClick={closeModal}
          >
            X
          </button>
          <div className="text-white font-bold mt-7">
            {" "}
            Enter your travel details so we can book your trip.
          </div>
