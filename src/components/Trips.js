        ...
        <div className="container mx-auto flex justify-center my-16">
            <div className="lg:w-1/4 w-full lg:pr-3">
                <div className="bg-gray-100 rounded-xl p-6">
                    ...
                    <img src="https://images.unsplash.com/photo-1498503182468-3b51cbb6cb24?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80"/>
